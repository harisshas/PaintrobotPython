...
#D:\Railways\Paint Robot\PaintRobotWindows
parentdir='D:/Railways/Paint Robot/PaintRobotWindows/';
datetimestring = strftime('%d/%m/%y %H:%M:%S %p')
screen_shot_cmd = 'scrot -e \'mv $f /home/pi/Desktop/PaintingRobot/screenshots/\''
logger = logging.getLogger('mylogger')

handler = logging.FileHandler(parentdir+'logs/PR.log')
...
def addlsettingsbutton():
    ...
    Horizontalfeedslider= tk.Scale(addlsettingsWindow, from_=100, to=1000, label="Set horizontal feed:", resolution=100, width =18, length = 200, orient=HORIZONTAL, command=updatewidthresolution, font=('Helvetica', 11, 'normal'))
    ...
    if CurrentMode == 1:
        ...
        baseheightslider= tk.Scale(addlsettingsWindow, from_=Type2baseheight-200, to=Type2baseheight+200, label="Set side wall base height:", resolution=1, width =18, length = 200, orient=HORIZONTAL, command=updatebaseheight, font=('Helvetica', 11, 'normal'))
...
def settingsbutton():
    ...
    def show_logs_button(*args):
        ...
        rd = open (parentdir+'logs/PR.log', "r")
...
#         Topaxistravellength=value;
    ...
    Spraytimeslider= tk.Scale(settingsWindow, from_=1000, to=60000, label="Set spray inch time:", resolution=1000, width =18, length = 200, orient=HORIZONTAL, command=updateSpraytime, font=('Helvetica', 11, 'normal'))
    Spraytimeslider.set(Spraytime)
    Spraytimeslider.grid(row=12, column=1)
    
#     Horizdistancelider= tk.Scale(settingsWindow, from_=200, to=5000, label="Set start distance:", resolution=100, width =18, length = 200, orient=HORIZONTAL, command=updateStartdistance, font=('Helvetica', 11, 'normal'))
#     Horizdistancelider.set(horizstartlength)
#     Horizdistancelider.grid(row=13, column=0)
#     
#     Verticalclearanceslider= tk.Scale(settingsWindow, from_=900, to=1200, label="Set vertical clearance:", resolution=1, width =18, length = 200, orient=HORIZONTAL, command=updateVerticalclearance, font=('Helvetica', 11, 'normal'))
#     Verticalclearanceslider.set(Yaxisbottomclearance)
#     Verticalclearanceslider.grid(row=13, column=1)
    
#     Horizontalfeedslider= tk.Scale(settingsWindow, from_=100, to=1000, label="Set horizontal feed:", resolution=100, width =18, length = 200, orient=HORIZONTAL, command=updatewidthresolution, font=('Helvetica', 11, 'normal'))
#     Horizontalfeedslider.set(widthresolution)
#     Horizontalfeedslider.grid(row=14, column=0)
#     
#     Yaxistravellengthslider= tk.Scale(settingsWindow, from_=2000, to=3000, label="Set Y axis travel length:", resolution=50, width =18, length = 200, orient=HORIZONTAL, command=updateYaxistravellength, font=('Helvetica', 11, 'normal'))
#     Yaxistravellengthslider.set(Yaxistravellength)
#     Yaxistravellengthslider.grid(row=14, column=1)
#     
#     Topaxistravellengthslider= tk.Scale(settingsWindow, from_=4000, to=6500, label="Set Top axis travel length:", resolution=50, width =18, length = 200, orient=HORIZONTAL, command=updateTopaxistravellength, font=('Helvetica', 11, 'normal'))
#     Topaxistravellengthslider.set(Topaxistravellength)
#     Topaxistravellengthslider.grid(row=15, column=0)
...
def sendsignal(sendtext):
    ...
    #global serwrite;
    sendpending=False;
    Sendpendtext=sendtext;
    ard_addr = usbaddr;
    #print('here in sendtext')
    #read_from_port(ser);
    #serialconnect();
    global ser
    #serwrite = serial.Serial(port=str(ard_addr), baudrate = 115200)
    try:
       #serflush()
       #sendtext+="\n";
...
mcresetpic = PhotoImage(file = parentdir+'images/icon_reset.png')
alarmoffpic = PhotoImage(file = parentdir+'images/alarmoff_icon.png')
alarmonpic = PhotoImage(file = parentdir+'images/alarmon_icon.png')
snapshotpic = PhotoImage(file = parentdir+'images/screen_shot.pgm')
settingsiconpic = PhotoImage(file = parentdir+'images/settings_icon.png')
addlsettingsiconpic = PhotoImage(file = parentdir+'images/addl_settings.png')
idleicon=PhotoImage(file = parentdir+'images/stop.png')
erroricon=PhotoImage(file = parentdir+'images/error.png')

inchupicon=PhotoImage(file = parentdir+'images/inch_up_icon.png')
inchdownicon=PhotoImage(file = parentdir+'images/inch_down_icon.png')
inchlefticon=PhotoImage(file = parentdir+'images/inch_left_icon.png')
inchrighticon=PhotoImage(file = parentdir+'images/inch_right_icon.png')
limitsengageicon=PhotoImage(file = parentdir+'images/limits_engaged_icon.png')
limitsdisengageicon=PhotoImage(file = parentdir+'images/limits_disengaged_icon.png')
sprayandmoveicon=PhotoImage(file = parentdir+'images/sprayandmove_icon.png')


inchtrayinicon=PhotoImage(file = parentdir+'images/inch_tray_in.png')
inchtrayouticon=PhotoImage(file = parentdir+'images/inch_tray_out.png')
sprayicon=PhotoImage(file = parentdir+'images/spray_icon.png')

TitleGroup = LabelFrame(master, text = "")
TitleGroup.grid(row=0, column=0)

AlarmDisplayGroup = LabelFrame(TitleGroup, text = "", width=400, height=1)
AlarmDisplayGroup.grid(row=0, column=0)

Datetimebutton = tk.Button(AlarmDisplayGroup, text="Date & Time", font=('Helvetica', 12, 'bold'), bd=0)
Datetimebutton.grid(row=0, column=0)

Statusbutton = tk.Button(AlarmDisplayGroup, text="Status label", font=('Helvetica', 13, 'bold'), bd=0, width=20, height=2, fg="red")
Statusbutton.grid(row=0, column=1)

Statusicon = tk.Label(AlarmDisplayGroup, bd=0, width=50, height=50, image=idleicon)
Statusicon.grid(row=0, column=2)

Titlelabel = tk.Label(AlarmDisplayGroup, text="Painting Robot - Goldenrock Workshops", font=('Helvetica', 15, 'bold'), width=32, height=2, bd=0)
Titlelabel.grid(row=0, column=3)

ComErrorAlarmlabel = tk.Label(AlarmDisplayGroup, text="Serialcomlabel", font=('Helvetica', 12, 'bold'), width=26, height=2, bd=0, fg="red")
ComErrorAlarmlabel.grid(row=0, column=4)

Snapshotbutton = tk.Button(AlarmDisplayGroup, text="", bd=0, image=snapshotpic, width=60, height=50)
...
Settingsbutton = tk.Button(AlarmDisplayGroup, text="", bd=0, image=settingsiconpic, command=settingsbutton, width=60, height=50)
Settingsbutton.grid(row=0, column=7)

#AlarmOnOffbutton = tk.Button(AlarmDisplayGroup, text="", bd=0, image=alarmoffpic, width=60, height=50)
...
radioGroup = LabelFrame(OptionsGroup, text = "Select Coach type", font=('Helvetica', 9, 'bold'))
radioGroup.pack()
...
#command pending
HorizontalSpeedslider= tk.Scale(OptionsGroup, from_=50, to=100, width =15, resolution=25, label = "X axis speed %",length = 150, orient=HORIZONTAL, command=updateXaxisspeed,font=('Helvetica', 9, 'bold'))
HorizontalSpeedslider.set(50)
HorizontalSpeedslider.pack()

#command pending
VerticalSpeedslider= tk.Scale(OptionsGroup, from_=50, to=100, width =15, resolution=25, label = "Y axis speed %",length = 150, orient=HORIZONTAL, command=updateYaxisspeed, font=('Helvetica', 9, 'bold'))
VerticalSpeedslider.set(50)
VerticalSpeedslider.pack()

Inchallcarraigevar=IntVar()
#command pending
Inchallcarraige = tk.Checkbutton(OptionsGroup, text='Inch All Carraiges', font=('Helvetica', 9, 'bold'), command=Inchallcarraigeselect, variable=Inchallcarraigevar)
...
Startbutton = tk.Button(OptionsGroup, text="Start", width=15, height=1, bd=1, font=('Helvetica', 13, 'bold'), fg="green", command=startbutton)        
Startbutton.pack()

Pausebutton = tk.Button(OptionsGroup, text="Pause", width=15, height=1, bd=1, font=('Helvetica', 13, 'bold'), fg="blue", command=pausebutton)        
Pausebutton.pack()

Stopbutton = tk.Button(OptionsGroup, text="Stop", width=15, height=1, bd=1, font=('Helvetica', 13, 'bold'), fg="red", command=stopbutton)        
Stopbutton.pack()

Resetbutton = tk.Button(OptionsGroup, text="Reset", width=15, height=1, bd=1, font=('Helvetica', 13, 'bold'), command=resetbutton)        
Resetbutton.pack()

StatusGroup = LabelFrame(DisplayGroup, text = "",width=1190, height=700)
StatusGroup.grid(row=0, column=1)

NorthsideStatusGroup = LabelFrame(StatusGroup, text = "",width=1190, height=172)
NorthsideStatusGroup.pack()

NorthsideTitle= tk.Label(NorthsideStatusGroup, text="North Side", font=('Helvetica', 14, 'bold'), bd=0)
NorthsideTitle.pack()

NorthsideliveStatus = LabelFrame(NorthsideStatusGroup, text = "",width=1190, height=172)
NorthsideliveStatus.pack()

NorthsidecoachliveStatus1 = LabelFrame(NorthsideliveStatus, text = "",width=45, height=172)
NorthsidecoachliveStatus1.grid(row=0, column=0)

NorthsidecoachliveStatus2 = LabelFrame(NorthsideliveStatus, text = "",width=1090, height=172)
NorthsidecoachliveStatus2.grid(row=0, column=1)

NorthsidecoachliveStatus3 = LabelFrame(NorthsideliveStatus, text = "",width=45, height=172)
NorthsidecoachliveStatus3.grid(row=0, column=2)

Northsideprogress= tk.Label(NorthsideStatusGroup, text="Progress - %", font=('Helvetica', 14, 'bold'), bd=0)
Northsideprogress.pack()

SouthsideStatusGroup = LabelFrame(StatusGroup, text = "",width=1190, height=172)
SouthsideStatusGroup.pack()

SouthsideTitle= tk.Label(SouthsideStatusGroup, text="South Side", font=('Helvetica', 14, 'bold'), bd=0)
SouthsideTitle.pack()

SouthsideliveStatus = LabelFrame(SouthsideStatusGroup, text = "",width=1190, height=172)
SouthsideliveStatus.pack()

SouthsidecoachliveStatus1 = LabelFrame(SouthsideliveStatus, text = "",width=45, height=172)
SouthsidecoachliveStatus1.grid(row=0, column=0)

SouthsidecoachliveStatus2 = LabelFrame(SouthsideliveStatus, text = "",width=1090, height=172)
SouthsidecoachliveStatus2.grid(row=0, column=1)

SouthsidecoachliveStatus3 = LabelFrame(SouthsideliveStatus, text = "",width=45, height=172)
SouthsidecoachliveStatus3.grid(row=0, column=2)

Southsideprogress= tk.Label(SouthsideStatusGroup, text="Progress - %", font=('Helvetica', 14, 'bold'), bd=0)
Southsideprogress.pack()

TopsideStatusGroup = LabelFrame(StatusGroup, text = "",width=1190, height=172)
TopsideStatusGroup.pack()

TopsideTitle= tk.Label(TopsideStatusGroup, text="Top Side", font=('Helvetica', 14, 'bold'), bd=0)
TopsideTitle.pack()

TopsideliveStatus = LabelFrame(TopsideStatusGroup, text = "",width=1190, height=172)
TopsideliveStatus.pack()

TopsidecoachliveStatus1 = LabelFrame(TopsideliveStatus, text = "",width=45, height=172)
TopsidecoachliveStatus1.grid(row=0, column=0)

TopsidecoachliveStatus2 = LabelFrame(TopsideliveStatus, text = "",width=1090, height=172)
TopsidecoachliveStatus2.grid(row=0, column=1)

TopsidecoachliveStatus3 = LabelFrame(TopsideliveStatus, text = "",width=45, height=172)
TopsidecoachliveStatus3.grid(row=0, column=2)

Topsideprogress= tk.Label(TopsideStatusGroup, text="Progress - %", font=('Helvetica', 14, 'bold'), bd=0)
Topsideprogress.pack()

disptime()

Sendpendtext=StringVar();
sendpending=BooleanVar();
